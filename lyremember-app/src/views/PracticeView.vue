<template>
  <MainLayout>
    <div class="space-y-6 pb-8">
      ...
      <div>
        <h1
          class="text-[28px] font-bold text-gold"
      ...
      >
        <div class="grid grid-cols-3 gap-4 text-center">
          <div>
            <p
              class="text-2xl font-bold text-gold"
              style="font-family: Georgia, 'Times New Roman', serif"
            >
      ...
      <div v-else-if="songsStore.songs.length === 0" class="text-center py-12">
        ...
        <Button variant="primary" class-name="mt-4" @click="$router.push('/songs/add')">
          <Plus :size="18" />
          {{ $t('practice.addASong') }}
        </Button>
      </div>
      ...
      <div v-else class="space-y-3">
        <div v-for="song in songsStore.songs" :key="song.id" class="space-y-3">
          <!-- Song card -->
          <div
          ...
          >
            <div class="flex items-center gap-3">
              ...
              <div class="text-right flex-shrink-0">
                <p class="text-lg font-bold text-gold">{{ getMasteryPercent(song.id) }}%</p>
          ...
          <div v-if="selectedSongId === song.id" class="grid grid-cols-2 gap-3 pl-2 pr-2">
            <!-- Texte à trous -->
            <div
            ...
            >
              <div
                class="w-10 h-10 rounded-full bg-[#F59E0B]/15 flex items-center justify-center mb-3"
              >
            ...
            >
              <div
                class="w-10 h-10 rounded-full bg-[#10B981]/15 flex items-center justify-center mb-3"
              >
            ...
            >
              <div
                class="w-10 h-10 rounded-full bg-[#EC4899]/15 flex items-center justify-center mb-3"
              >
            ...
            >
              <div
                class="w-10 h-10 rounded-full bg-[#6366F1]/15 flex items-center justify-center mb-3"
              >
